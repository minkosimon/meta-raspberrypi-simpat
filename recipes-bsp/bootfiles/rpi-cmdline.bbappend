...
# if SUPPORT_BOOT is set , adapt the command line
...
def setup_boot_over_ethernet(d):
    ...
    """
    support_boot = d.getVar('SUPPORT_IMG_TYPE') or "rootfs"
    ...
    if support_boot == "nfs":
        ...
        bb.plain("cmdline : NFS boot mode")
