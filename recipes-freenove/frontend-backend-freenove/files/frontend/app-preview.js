...
function LedMatrixPanel({ ws, disabled }) {
  ...
  return h(
    ...
    h(
      ...
      h(
        "button",
        { className: "btn sm", onClick: () => applyPreset("smile") },
        "Smile",
      ),
      h(
        "button",
        { className: "btn sm", onClick: () => applyPreset("heart") },
        "Coeur",
      ),
      h(
        "button",
        { className: "btn sm", onClick: () => applyPreset("arrow") },
        "Fleche",
      ),
...
function ActiveBuzzerPanel({ ws, disabled }) {
  ...
  return h(
    Card,
    { icon: "🔔", title: "Buzzer Actif", badge: "GPIO17" },
    h(
      "button",
      {
